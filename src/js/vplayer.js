var app = new Vue({
    ...
    methods: {
        ...
        firstOrCreate: function() {
            ...
            this.$http.get('api/mp3url.php', {params:{ 'id': this.playingLists[0].id }})
        ...
        formSubmit: function() {
            ...
            this.$http.get('api/search.php', {params:{'s': this.search}})
            .then(function(response) {
        ...
        playMusic: function(id) {
            ...
            this.getMp3Url(id);
            this.$http.get('api/detail.php', {params: { 'id': id }})
            .then(function(response) {
        ...
        getMp3Url: function(id) {
            this.$http.get('api/mp3url.php', {params:{ 'id': id }})
            .then(function(response) {
                var mp3 = response.body.data[0];
                switch(mp3.code)
                {
        ...
        getSongLyric: function(id) {
            this.$http.get('api/lyric.php', {params: { 'id': id }})
            .then(function(response) {
        ...
        prevPage: function() {
            ...
            this.pageNumber--;
            this.$http.get('api/pages.php', {params: { 's': this.search, 'p': this.pages }})
            .then(function(response) {
                this.songLists = response.body.result.songs;
            }, function(error) {
                // error callback
